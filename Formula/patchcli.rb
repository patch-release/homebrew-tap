...
class Patchcli < Formula
  ...
  url "https://storage.googleapis.com/patch-cli-dist/patchcli-1.6.21-macos.tar.gz"
  version "1.6.21"
  sha256 "1f1d8039c8ebf027d20a2d4022eb95f8430f65f7f3044db41c2e525934a75d37"
  license "MIT"
  ...
  test do
    assert_match "1.6.21", shell_output("#{bin}/patchcli --version")

...
class Patch < Formula
  ...
  url "https://storage.googleapis.com/patch-cli-dist/patch-0.2.0-macos.tar.gz"
  version "0.2.0"
  sha256 "b2c52e0b977f19525a839aa8ef29c2896146ebe9c1300b61faf9d92dde8f2bf9"
  license "MIT"
  ...
  test do
    assert_match "0.2.0", shell_output("#{bin}/patch --version")

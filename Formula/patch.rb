...
class Patch < Formula
  ...
  url "https://storage.googleapis.com/patch-cli-dist/patch-1.0.0-macos.tar.gz"
  version "1.0.0"
  sha256 "8d31418202fbba00778b748811a3f33f9ede46013555c562556b510cccfde4e3"
  license "MIT"
  ...
  test do
    assert_match "1.0.0", shell_output("#{bin}/patch --version")
